package es.blastic.soap.empleado.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema empleadoSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://blastic.es/soap/empleado");
    ...
    public XsdSchema empleadoSchema() {
        return new SimpleXsdSchema(new ClassPathResource("wsdl/empleado.xsd"));
    }
}